...
static const Theme kThemes[APPEAR_N] = {
    /* APPEAR_SYS6 */ { 0, 0 },   /* square key-caps, flat frames — System 6 lined look */
    /* APPEAR_SYS7 */ { 6, 0 },   /* == today: rounded key-caps, flat 1px frames        */
    /* APPEAR_SYS8 */ { 4, 1 },   /* Platinum: gentler corners, bevelled frames         */
};
